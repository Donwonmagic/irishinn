...
const MENUS = {
    allday: [
        ...
        { category: "Small Plates", name: "Popcorn Shrimp", price: 16, description: "Deep-fried shrimp served with cherry pepper dipping sauce.", tags: ["df"], image: "shrimp.jpg" },
        ...
        { category: "Small Plates", name: "Hummus", price: 13, description: "Creamy hummus with pita, cucumbers, cherry tomato & olives.", tags: ["v", "vg", "df"], image: "hummus.jpg" },
        { category: "Small Plates", name: "Deviled Eggs", price: 12, description: "Topped with smoked salmon, tomato, caper & red onion.", tags: ["gf", "df"], image: "eggs.jpg" },
        ...
        { category: "Small Plates", name: "Mussels & Clams", price: 21, description: "Fresh clams and PEI mussels in tomato, white wine, garlic & shallot broth.", tags: ["gf", "df"], image: "mussels.jpg" },
        ...
        { category: "Salads", name: "Irish Greens", price: 14, description: "Arcadian greens, tomato, cucumber, carrot, watermelon radish & Irish mustard vinaigrette.", tags: ["v", "vg", "gf", "df"], image: "greens.jpg" },
        ...
        { category: "Handhelds", name: "Ahi Tuna Sandwich", price: 24, description: "Seared ahi tuna, avocado, lettuce, tomato & wasabi aioli on multigrain.", tags: ["df"], image: "tuna_sand.jpg" },
        ...
        { category: "Handhelds", name: "Beyond Burger", price: 20, description: "Plant-based burger, LTO, guacamole & 1000 island on Gluten Free bun.", tags: ["v", "vg", "gf", "df"], image: "beyond.jpg" },
        ...
        { category: "Signatures", name: "Fish and Chips", price: 24, description: "Guinness-battered cod with fries, coleslaw & tartar sauce.", tags: ["df"], image: "fishchips.jpg" },
        { category: "Signatures", name: "Seafood Stew", price: 34, description: "Shrimp, scallops, mussels & fish in white wine & herb broth with fennel & garlic bread.", tags: ["df"], image: "seafood_stew.jpg" },
        ...
        { category: "Signatures", name: "Coconut Curry", price: 24, description: "Chickpeas, cauliflower, bell pepper & fingerling potatoes in coconut curry with jasmine rice.", tags: ["v", "vg", "gf", "df"], image: "curry.jpg" },
    ...
    brunch: [
        ...
        { category: "Brunch Starters", name: "House-Made Hummus", price: 13, description: "Olive oil, fresh tomatoes, cucumbers, black olives. Served with freshly fried pita.", tags: ["v", "vg", "df"], image: "hummus.jpg" },
        ...
        { category: "Brunch Starters", name: "Deviled Eggs", price: 12, description: "Four creamy deviled eggs topped with savory smoked salmon.", tags: ["gf", "df"], image: "eggs.jpg" },
        ...
        /* --- BRUNCH SALADS --- */
        { category: "Brunch Salads", name: "Irish Greens Salad", price: 14, description: "Fresh baby tomatoes, cucumbers, carrots, watermelon radish in zesty country vinaigrette.", tags: ["v", "vg", "gf", "df"], image: "greens.jpg" },
        ...
        { category: "Lunch Favorites", name: "Ahi Tuna Sandwich", price: 24, description: "Seared ahi tuna, avocado, fresh tomatoes on toasted wheat bread with wasabi aioli.", tags: ["df"], image: "tuna_sand.jpg" },
        ...
        { category: "Lunch Favorites", name: "Beyond Burger", price: 20, description: "6oz plant-based burger, guacamole, LTO, 1000 island on brioche bun.", tags: ["v", "gf", "df"], image: "beyond.jpg" },
        ...
        { category: "Traditional Fare", name: "Fish and Chips", price: 24, description: "Guinness-battered wild Alaskan cod, fries, coleslaw, tartar sauce.", tags: ["df"], image: "fishchips.jpg" },
...
function switchMenu(menuType) {
    activeMenu = menuType;
    activeFilters = []; // Reset filters when switching tabs
...
function renderMenu() {
    ...
    // STOP if we are not on the menu page (prevents errors on Home page)
    ...
    if (categoryList) {
        ...
        // Re-attach click listeners for "active" state
    ...
    categories.forEach(cat => {
        ...
        items.forEach(item => {
            ...
            // Image Logic (Uses background color if no image found)
            const bgStyle = item.image ? `background-image: url('${item.image}');` : `background-color: #f4f4f4;`;
...
function checkStatus() {
    ...
    // HOURS LOGIC:
    // Mon-Thu: 11:30am (11.5) - 9:30pm (21.5)
    // Fri-Sat: 11:30am (11.5) - 10:30pm (22.5)
    // Sun:     11:00am (11.0) - 9:30pm (21.5)
...
/* =========================================
   ...
   ========================================= */
// Expose functions to HTML (so onclick works)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Check for Menu Container and Load Menu
    const menuContainer = document.getElementById('menu-container');
    if (menuContainer) {
        // Auto-Detect Brunch on Weekends (Sat/Sun before 3pm)
        const now = new Date();
        const day = now.getDay();
        const hour = now.getHours();

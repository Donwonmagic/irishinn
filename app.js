...
const MENUS = {
    ...
    /* --- BRUNCH (Weekends) --- */
    brunch: [
        { category: "Brunch Starters", name: "Irish Pancake Breakfast", price: 18, description: "Two eggs, bacon or sausage, stack of pancakes (Strawberry, Nutella, or Maple).", tags: [], image: "pancakes.jpg" },
        { category: "Brunch Starters", name: "Bailey's French Toast", price: 18, description: "Rich French toast infused with Bailey's Irish Cream. Served with eggs & meat.", tags: [], image: "french_toast.jpg" },
        ...
        { category: "Brunch Mains", name: "Corned Beef Hash", price: 24, description: "Beef mixed with peppers and roasted potatoes, topped with two eggs.", tags: ["gf"], image: "hash.jpg" },
        ...
        { category: "Brunch Mains", name: "Crispy Fish Sandwich", price: 20, description: "Fried cod on brioche, tangy tartar sauce, creamy coleslaw.", tags: [], image: "fish_sand.jpg" }
    ]
};
...
// GLOBAL FUNCTION DEFINITIONS (Must be accessible to HTML)
...
function renderMenu() {
    ...
    // Safety Check: If we are on a page without a menu (like Home), stop here.
    ...
    // 2. Render Category Links (Sticky Nav)
    if (categoryList) {
        ...
        updateScrollSpy(); // Re-attach listeners
    }
    ...
    if (gridHTML === '') {
        gridHTML = `<div class="text-center" style="padding:4rem;"><h3>No items match these filters.</h3></div>`;
    }
...
// MAKE FUNCTIONS GLOBAL (Crucial for HTML onclick="...")
